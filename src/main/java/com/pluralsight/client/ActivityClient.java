...
public class ActivityClient {
	...
	public Activity get(String id) {
		...
		//http://localhost:8080/services/webapi/activities/{id}
	...
	public Activity create(Activity act) {
		...
		//http://localhost:8080/services/webapi/activities/activity
		WebTarget target = client.target("http://localhost:8080/services/webapi/");
		
		Response response = target.path("activities/activity").request(MediaType.APPLICATION_JSON).post(Entity.entity(act, MediaType.APPLICATION_JSON));
	...
	public Activity update(Activity act) {
		...
		Response response = target.path("activities/" + act.getId()).request(MediaType.APPLICATION_JSON).put(Entity.entity(act, MediaType.APPLICATION_JSON));
	...
	public void delete(String actId) {
		...
		Response response = target.path("activities/" + actId).request(MediaType.APPLICATION_JSON).delete();
